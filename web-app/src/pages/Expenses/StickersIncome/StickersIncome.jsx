...
import MonthlyDuesIncomeDetails from "../MonthlyDuesIncome/MonthlyDuesIncomeDetails";
  ...
  return (
    <div className="border-l-8 bg-primary bg-opacity-45 border-opacity-50 rounded-2xl border-primary hover:bg-darkerGreen hover:border-primary hover:border-b-8 hover:border-opacity-40 hover:bg-opacity-60 p-4 shadow-lg">
      <div className="flex items-center justify-between">
        <div>
          <div className="text-xs text-white">Stickers</div>
        </div>
      ...
      <div className="flex items-center justify-between mb-3">
        {loading ? (
          ...
          <div className="text-2xl font-semibold text-white">
            {incomes && incomes.car_stickers
              ? formatIncome(incomes.car_stickers)
              : "₱0.00"}
          </div>
        )}
      </div>
