...
import MonthlyDueIncomeTable from "./MonthlyDueIncomeTable";
...
const MonthlyDuesIncomeDetails = ({ onClose }) => {
  ...
  useEffect(() => {
    // Fetch the income data when the year and month change
      ...
      <div className="flex justify-between">
        ...
        <div className="text-4xl p-4 justify-center">
          {loading ? (
            ...
            <div>
              <div className="mb-2">
                <strong>Total Income for Bills:</strong>{" "}
                {formatIncome(incomes.bills)}
              </div>
            </div>
          ) : (
